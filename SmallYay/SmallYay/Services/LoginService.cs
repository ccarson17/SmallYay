...
namespace SmallYay
{
    class LoginService
    {
        ...
        public string BuildAuthenticationUrl()
        {
            ...
            return $"{Constants.OrgUrl}/oauth2/default/v1/authorize?response_type={IDToken}&scope=openid%20profile&redirect_uri={Constants.RedirectUri}&client_id={Constants.ClientId}&state={state}&code_challenge={codeChallenge}&code_challenge_method={CodeChallengeMethod}&nonce={nonce}";
        }
